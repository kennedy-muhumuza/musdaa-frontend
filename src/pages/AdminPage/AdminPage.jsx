...
export function AdminPage() {
  return (
    <div className="mt-0 p-8 grid gap-16">
      {/* <LoggedHeader /> */}
      <AdminHeader />
      <div className="mb-12 grid gap-y-10 gap-x-0 md:grid-cols-4 xl:grid-cols-4">
      ...
      <div className="mb-4 grid grid-cols-3 gap-6 xl:grid-cols-3">
        <Card className=" col-span-2 overflow-hidden xl:col-span-2">
          <CardHeader
            floated={false}
            shadow={false}
            color="transparent"
                    ...
                    return (
                      <tr key={name}>
                        <td className={className}>
                          <div className="flex items-center gap-4 border-collapse">
        ...
        <Card>
          ...
          <CardBody className="col-span-1 pt-0">
